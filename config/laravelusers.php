...
return [
    ...
    */
    ...
    'laravelUsersBladeExtended'     => 'adminlte::page', //'laravelusers::layouts.app', // 'layouts.app'
    ...
    'showUsersBlade'                => 'usersmanagement.show-users', //'laravelusers::usersmanagement.show-users',
    'createUserBlade'               => 'usersmanagement.create-user', //'laravelusers::usersmanagement.create-user',
    'showIndividualUserBlade'       => 'usersmanagement.show-user', // 'laravelusers::usersmanagement.show-user',
    'editIndividualUserBlade'       => 'usersmanagement.edit-user', //'laravelusers::usersmanagement.edit-user',
