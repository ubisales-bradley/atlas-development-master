...
{{--                                <div class="col-md-9">--}}
{{--                                    <div class="input-group">--}}
{{--                                        {!! Form::text('businessname', NULL, array('id' => 'businessname', 'class' => 'form-control', 'placeholder' => 'Business name (Will populate & hide)')) !!}--}}
{{--                                        <div class="input-group-append">--}}
...
{{--                            </div>--}}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('MSISDN') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('MSISDN', NULL, array('id' => 'MSISDN', 'class' => 'form-control', 'placeholder' => 'Phone Number')) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="MSISDN">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                <i class="fa fa-fw {!! trans('laravelusers::forms.create_user_icon_username') !!}" aria-hidden="true"></i>
                                            @else
                                                Firstname
