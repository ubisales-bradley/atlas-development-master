                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')) !!}
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('firstname') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('firstname', $user->firstname, array('id' => 'firstname', 'class' => 'form-control', 'placeholder' => 'Firstname')) !!}
                                        <div class="input-group-append">
                            ...
                            <div class="form-group has-feedback row {{ $errors->has('lastname') ? ' has-error ' : '' }}">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        {!! Form::text('lastname', $user->lastname, array('id' => 'lastname', 'class' => 'form-control', 'placeholder' => 'Lastname')) !!}
                                        <div class="input-group-append">
...
{{--                                @if(config('laravelusers.fontAwesomeEnabled'))--}}
{{--                                    {!! Form::label('businessname', 'Businessname', array('class' => 'col-md-3 control-label')); !!}--}}
{{--                                @endif--}}
{{--                                <div class="col-md-9">--}}
{{--                                    <div class="input-group">--}}
{{--                                        {!! Form::text('businessname', $user->businessname, array('id' => 'businessname', 'class' => 'form-control', 'placeholder' => 'Business Name (Will populate & hide)')) !!}--}}
{{--                                        <div class="input-group-append">--}}
{{--                                            <label class="input-group-text" for="businessname">--}}
{{--                                                @if(config('laravelusers.fontAwesomeEnabled'))--}}
{{--                                                    <i class="fa fa-fw {!! trans('laravelusers::forms.create_user_icon_username') !!}" aria-hidden="true"></i>--}}
{{--                                                @else--}}
{{--                                                    Lastname--}}
...
{{--                            </div>--}}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('MSISDN') ? ' has-error ' : '' }}">
                            @if(config('laravelusers.fontAwesomeEnabled'))
                                {!! Form::label('MSISDN', 'Phone Number', array('class' => 'col-md-3 control-label')); !!}
                            @endif
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('MSISDN', $user->MSISDN, array('id' => 'MSISDN', 'class' => 'form-control', 'placeholder' => 'Phone Number')) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="businessname">
                                            @if(config('laravelusers.fontAwesomeEnabled'))
                                                <i class="fa fa-fw {!! trans('laravelusers::forms.create_user_icon_username') !!}" aria-hidden="true"></i>
